            ...
            tabItem(
                ...
                fluidRow(
                    ...
                    fluidRow(
                        ...
                        tags$style(".small-box.bg-fuchsia { background-color: #0069B4 !important; color: #FFFFFF !important; }"),
                        tags$style(".fa-graduation-cap { color: #FF56B3}"),
                        tags$style(".fa-award {color: #FF56B3}"),
                        tags$style(".fa-school {color: #5b87c4}"),
                        tags$style(".fa-clipboard {color: #FF56B3}"),
                        tags$style(".fa-users {color: #5b87c4}"),
                        tags$style(".fa-walking {color: #5b87c4}"),
                        tags$style(".fa-medal {color: #5b87c4}"),
